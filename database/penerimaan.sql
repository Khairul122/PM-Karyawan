...
--
-- Host: localhost:3306
-- Generation Time: Jan 30, 2024 at 12:09 AM
...
--
ALTER TABLE `master_pelamar`
  MODIFY `id_pelamar` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `pm_aspek`
  MODIFY `id_aspek` tinyint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `pm_faktor`
--
ALTER TABLE `pm_faktor`
  MODIFY `id_faktor` tinyint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `pm_sample`
--
ALTER TABLE `pm_sample`
  MODIFY `id_sample` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=561;
COMMIT;

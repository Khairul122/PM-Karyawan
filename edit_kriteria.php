				...
				<div class="col-sm-6 offset-sm-3">
					...
					<div class="form-group">
						...
						<select name="target" id="target" class="form-control" required="true">
							<option value="1" <?php if ($target == "1"){ echo "selected"; } ?>>Kurang</option>
							<option value="2" <?php if ($target == "2"){ echo "selected"; } ?>>Cukup</option>
							<option value="3" <?php if ($target == "3"){ echo "selected"; } ?>>Baik</option>
							<option value="4" <?php if ($target == "4"){ echo "selected"; } ?>>Sangat Baik</option>
						</select>
					</div>
					<div class="form-group">
						<label>Type</label>
